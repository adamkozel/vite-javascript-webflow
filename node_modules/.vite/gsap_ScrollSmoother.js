...
var ScrollSmoother = function() {
  function ScrollSmoother2(vars) {
    ...
    _mainInstance = this;
    var content, wrapper, height, mainST, effects, intervalID, wrapperCSS, contentCSS, paused, pausedNormalizer, scrollFunc = ScrollTrigger.getScrollFunc(_win), smoothDuration = ScrollTrigger.isTouch === 1 ? vars.smoothTouch === true ? 0.8 : parseFloat(vars.smoothTouch) || 0 : vars.smooth === 0 || vars.smooth === false ? 0 : parseFloat(vars.smooth) || 0.8, currentY = 0, delta = 0, startupPhase = 1, _onUpdate = vars.onUpdate, onStop = vars.onStop, tracker = _getVelocityProp(0), updateVelocity = function updateVelocity2() {
      ...
      return -currentY;
    }, lastFocusElement, onFocusIn = function onFocusIn2(e) {
      wrapper.scrollTop = 0;
    ...
    this.offset = function(target, position) {
      ...
      var oldY = gsap.getProperty(target, "y"), st = ScrollTrigger.create({
        trigger: target,
    ...
    this.effects = function(targets, _ref) {
      var _effects;
      var speed = _ref.speed, lag = _ref.lag;
      effects || (effects = []);
      if (!targets) {
